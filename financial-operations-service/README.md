...
The service uses suspending Kotlin coroutine handlers and R2DBC adapters. Financial commands use `TransactionalOperator.executeAndAwait` while preserving the transaction-bound connection and deterministic transfer locking.
